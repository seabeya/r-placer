  ...
  return (
    <footer className="mt-5">
      <div className="text-center text-sm text-white sm:text-base">
        ...
        <a href={CONSTS.githubUrl} target="_blank" rel="noopener noreferrer" className="ml-6 hover:underline">
          GitHub
        </a>
      </div>
      ...
      <p className="mt-2 w-full text-center text-xs text-gray-400" suppressHydrationWarning={true}>
